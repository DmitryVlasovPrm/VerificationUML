...
namespace Verification.rating_system {
    class RateDefiner {
        ...
        private static IDictionary<ALL_MISTAKES, double> gradesCD = new Dictionary<ALL_MISTAKES, double>() {
            ...
            {ALL_MISTAKES.CD_SMALL_LETTER, 1.0},
            {ALL_MISTAKES.CD_IMPOSSIBLE_SYMBOLS, 1.0},
            {ALL_MISTAKES.CD_EMPTY_CLASS, 1.0},
            {ALL_MISTAKES.CD_MUST_BE_ATTRIB, 1.0},
            {ALL_MISTAKES.CD_BIG_LETTER, 1.0},
            {ALL_MISTAKES.CD_CONSTRUCTOR_HAS_SMALL_LETTER, 1.0},
            {ALL_MISTAKES.CD_DESTRUCTOR_HAS_SMALL_LETTER, 1.0},
            {ALL_MISTAKES.CD_OPER_START_WITH_BIG_LETTER, 1.0},
            {ALL_MISTAKES.CD_OPER_HAS_BLANKS, 1.0},
            {ALL_MISTAKES.CD_HAS_OUTPUT_TYPE, 1.0},
            {ALL_MISTAKES.CD_POINT_OUTPUT_OPERATION_TYPE, 1.0},
            {ALL_MISTAKES.CD_NO_AVAILABLE_LINKS, 1.0},
            {ALL_MISTAKES.CD_ENUM_START_WITH_SMALL_LETTER, 1.0},
            {ALL_MISTAKES.CD_ENUM_HAS_BLANKS, 1.0},
            ...
            {ALL_MISTAKES.CD_WRONG_DIAPOSON, 1.0},
            {ALL_MISTAKES.CD_HAS_NAME, 1.0},
            {ALL_MISTAKES.CD_ENUM_HAS_NAME, 1.0},
