...
namespace Verification.Properties {
    ...
    internal class Resources {
        ...
        ///5 | 1 | у операции (кроме конструктора и деструктора) не указан возвращаемый тип | | Синтаксиче [остаток строки не уместился]&quot;;.
        /// </summary>
        ...
        ///{\pard Для установления связи между XMI файлом и PNG изображением необходимо, чтобы имена файлов были  [остаток строки не уместился]&quot;;.
        /// </summary>
        ...
        ///5 | 1 | Элем [остаток строки не уместился]&quot;;.
        /// </summary>
