...
namespace Verification.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   Ищет локализованную строку, похожую на 1 | СЕРЬЕЗНОСТЬ | ОШИБКА | ОПИСАНИЕ | ПРИЧИНЫ ОШИБКИ | ЭТАП ПРОВЕРКИ .
        /// </summary>
        ...
        /// <summary>
        ///   Ищет локализованную строку, похожую на &lt;b&gt;О программе&lt;/b&gt;
        ///Данная программа предназначена для верификации UML диаграммы активностей (ДА), классов (ДК) и прецедентов (ДП).
        ///.
        /// </summary>
